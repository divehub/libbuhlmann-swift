...
public struct PressureConverter {
    ...
    private static let densitySaltWater = 1020.0  //  EN13319
    ...
    public static func metersToBar(
        depth: Double, surfacePressure: Double = 1.01325, density: Double = 1020.0
    ) -> Double {
    ...
    public static func barToMeters(
        pressure: Double, surfacePressure: Double = 1.01325, density: Double = 1020.0
    ) -> Double {
